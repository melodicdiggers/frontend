...
export default function RegisterCard({ ismodal }: RegisterCardProps) {
				...
				<div className='dark:bg-gray-800 dark:border-gray-700 w-full rounded-lg dark:border sm:max-w-md md:mt-0 xl:p-0'>
					<div className='space-y-4 p-6 sm:p-8 md:space-y-6'>
						...
						<form className='space-y-4 md:space-y-6' onSubmit={handleSubmit}>
							<div>
								<label htmlFor='name' className='text-gray-900 font-mediu mb-2 block text-sm'>
									Your name
								</label>
								<input
									type='text'
							...
							<div>
								<label htmlFor='email' className='text-gray-900 mb-2 block text-sm font-medium'>
									Your email
								</label>
								<input
									type='email'
